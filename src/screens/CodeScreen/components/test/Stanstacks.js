...
const Stanstacks = () => {
	...
	// hook search detail
	const { placeData: { value, isLoading, isSuccess, error, status }, setPlaceId } = usePlaceDetail('ChIJSzCx8cesNTER5nQ3fDSKkVE');
	...
	return (
		<View style={{ flex: 1 }}>
			...
			<Button title='search = ha noi' onPress={() => {
				setSearchText('ha noi');
			}}></Button>

			<DerectionMap></DerectionMap>
